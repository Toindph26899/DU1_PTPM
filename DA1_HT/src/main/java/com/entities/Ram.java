...
@NamedQueries({
    ...
    @NamedQuery(name = "Ram.findByMa", query = "SELECT r FROM Ram r WHERE r.ma = :ma"),
    @NamedQuery(name = "Ram.findByTen", query = "SELECT r FROM Ram r WHERE r.ten = :ten")})
public class Ram implements Serializable {
    ...
    public String toString() {
        return "Ram{" + "id=" + id + ", ma=" + ma + ", ten=" + ten + ", chiTietSPList=" + chiTietSPList + '}';
    }
