...
@NamedQueries({
    ...
    @NamedQuery(name = "MauSac.findById", query = "SELECT m FROM MauSac m WHERE m.id = :id"),
    @NamedQuery(name = "MauSac.findByMa", query = "SELECT m FROM MauSac m WHERE m.ma = :ma"),
    @NamedQuery(name = "MauSac.findByTen", query = "SELECT m FROM MauSac m WHERE m.ten = :ten")})
public class MauSac implements Serializable {
    ...
    public String toString() {
        return "MauSac{" + "id=" + id + ", ma=" + ma + ", ten=" + ten + ", chiTietSPList=" + chiTietSPList + '}';
    }
